...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT tbl_agenda.*, tbl_kategori_agenda.nama_kategori FROM tbl_agenda INNER JOIN tbl_kategori_agenda ON tbl_agenda.id_kategori = tbl_kategori_agenda.id WHERE tbl_agenda.id = $id");
					...
					<div class="card-header">
						<div class="clearfix">
							<div class="float-left">
								Detail agenda - <strong><?= $row['judul'] ?> - <?= $row['nama_kategori'] ?></strong>
							</div>
