...
$query = mysqli_query($koneksi, "SELECT tbl_agenda.*, tbl_kategori_agenda.nama_kategori FROM tbl_agenda LEFT JOIN tbl_kategori_agenda ON tbl_agenda.id_kategori = tbl_kategori_agenda.id");
$no = 1;
$active = 'agenda';
?>
<!DOCTYPE html>
					...
					<div class="card-body">
						...
						<table id="table_id" class="dataTable table table-bordered">
						    <thead>
						        <tr>
						            <th>No</th>
						            <th width="250px">Gambar Agenda</th>
						            <th>Judul Agenda</th>
