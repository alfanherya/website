...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 100000000){
		...
		$query = mysqli_query($koneksi, "INSERT INTO tbl_artikel (judul, isi, tanggal, penulis, foto, id_kategori) VALUES('$judul', '$isi', '$tanggal', '$penulis', '$nama_foto', $id_kategori)") or die(mysqli_error($koneksi));
