...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		...
		// ubah data
		$query = mysqli_query($koneksi, "UPDATE tbl_artikel SET judul = '$judul', id_kategori = '$id_kategori', isi = '$isi', penulis = '$penulis', foto = '$nama_foto' WHERE id = $id") or die(mysqli_error($koneksi));
		if($query){
