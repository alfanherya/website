						...
						<form method="POST" action="proses_ubah.php?id=<?= $artikel['id'] ?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								*gambar sebelumnya <br>
								<img src="../../images/artikel/<?= $artikel['foto'] ?>" alt="" width="500px" class="mt-2">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" value="<?= $artikel['penulis'] ?>" class="form-control" id="penulis" placeholder="Penulis" autocomplete="off" required="required" name="penulis">
							</div>
							<div class="form-group">
