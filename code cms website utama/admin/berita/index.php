...
$query = mysqli_query($koneksi, "SELECT tbl_berita.*, tbl_kategori_berita.nama_kategori FROM tbl_berita LEFT JOIN tbl_kategori_berita ON tbl_berita.id_kategori = tbl_kategori_berita.id");
$no = 1;
$active = 'berita';
?>
<!DOCTYPE html>
						...
						<table id="table_id" class="dataTable table table-bordered">
						    ...
						    <tbody>
						        <?php while($row = mysqli_fetch_assoc($query)) : ?>
									<tr>
										<td><?= $no++ ?></td>
										<td><img src="../../images/berita/<?= $row['foto'] ?>" alt="" width="100%" class="img-thumbnail"></td>
