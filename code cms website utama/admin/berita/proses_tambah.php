...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		if (file_exists('../../images/berita/' . $nama_foto)) unlink('../../images/berita/' . $nama_foto);

		$query = mysqli_query($koneksi, "INSERT INTO tbl_berita (judul, isi, tgla, penulis, foto, id_kategori) VALUES('$judul', '$isi', '$tgla', '$penulis', '$nama_foto', $id_kategori)") or die(mysqli_error($koneksi));
