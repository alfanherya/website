...
$query = mysqli_query($koneksi, "SELECT tbl_pengumuman.*, tbl_kategori_pengumuman.nama_kategori FROM tbl_pengumuman LEFT JOIN tbl_kategori_pengumuman ON tbl_pengumuman.id_kategori = tbl_kategori_pengumuman.id");
$no = 1;
$active = 'pengumuman';
?>
<!DOCTYPE html>
					...
					<div class="card-body">
						...
						<table id="table_id" class="dataTable table table-bordered">
						    <thead>
						        <tr>
						            <th>No</th>
						            <th width="100px">Gambar pengumuman</th>
