...
if($_FILES['foto']['error'] == 0){
	if($_FILES['foto']['size'] < 1000000){
		if (file_exists('../../images/pengumuman/' . $nama_foto)) unlink('../../images/pengumuman/' . $nama_foto);

		$query = mysqli_query($koneksi, "INSERT INTO tbl_pengumuman (judul, isi, tgla, foto, id_kategori) VALUES('$judul', '$isi', '$tgla', '$nama_foto', $id_kategori)") or die(mysqli_error($koneksi));
