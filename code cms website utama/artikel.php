...
$query = mysqli_query($koneksi, "SELECT id, judul, isi, tanggal, penulis, foto FROM tbl_artikel");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="col-lg-4 col-md-12 mb-4">
              ...
              <div class="card card-cascade wider mb-4">
                ...
                <div class="view view-cascade">
                  <img src="images/artikel/<?= $row['foto'] ?>" class="card-img-top">
                  <a href="#!">
                ...
                <div class="card-body card-body-cascade text-left">
                  ...
                  <!--Text-->
                  <p class="card-text"><i class="far fa-calendar-alt"></i>&nbsp <?= $row['tanggal'] ?></p>
                  <p class="card-text"><i class="fas fa-user-edit"></i>&nbsp <?= $row['penulis'] ?></p>

                  <a href="detailartikel.php?id=<?= $row['id'] ?>" class="btn btn-outline-primary waves-effect"><i class="fas fa-sun pr-2" aria-hidden="true"></i>KUNJUNGI</a>
                </div>
                <!--/.Card content-->
