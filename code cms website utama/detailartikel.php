...
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT id, judul, isi, tanggal, penulis, foto FROM tbl_artikel WHERE id = $id");
    ...
    <div class="container">
      ...
      <div class="clearfix">
        <div class="float-center" align="center">
          <h3><strong><?= $row['judul'] ?></strong></h3> <br>
          <h6 align="center"><i class="fas fa-user-edit"></i>&nbsp <strong><?= $row['penulis'] ?></strong></h6>
        </div>
      </div>
    </div>
	  <div class="card-body">
		  <img src="images/artikel/<?= $row['foto'] ?>" alt="<?= $row['judul'] ?>" style="float:left; margin:5px" width="50%" class="img-thumbnail"><p style="margin:2;" align="justify"><?= $row['isi'] ?></p><br><br>
...
<br><br><br><br><br><br><br><br><br><br><br><br> <hr class="mb-5">
  <!--Footer-->
  <?php
  include('footer.php');
  ?>
